...
const MOCK_SNAPSHOTS: Snapshot[] = [
  ...
  { id:'4',  data:'', turno:'SEGUNDO', maquina:'MÁQ 04', produtoNome:'Frasco 500ml',    cicloAtual:0,  cavidadeReal:0,  velocidade:0,   status:'PARADA',       op:null, qtdOP:null, qtdAtual:null, observacao:'Aguardando técnico', divergente:false, manualOverride:false, produto:{id:'',codigo:'',descricao:'Frasco 500ml',    ciclopadrao:45, cavidadepadrao:20, ativo:true, createdAt:''} },
  { id:'5',  data:'', turno:'SEGUNDO', maquina:'MÁQ 05', produtoNome:'Tampa Rosca',     cicloAtual:15, cavidadeReal:32, velocidade:130, status:'EM_PRODUCAO',  op:null, qtdOP:null, qtdAtual:null, observacao:null, divergente:false, manualOverride:false, produto:{id:'',codigo:'',descricao:'Tampa Rosca',     ciclopadrao:15, cavidadepadrao:32, ativo:true, createdAt:''} },
  { id:'6',  data:'', turno:'SEGUNDO', maquina:'MÁQ 06', produtoNome:'Haste 30 mm',     cicloAtual:25, cavidadeReal:16, velocidade:100, status:'SETUP_DE_COR', op:null, qtdOP:null, qtdAtual:null, observacao:null, divergente:false, manualOverride:false, produto:{id:'',codigo:'',descricao:'Haste 30 mm',     ciclopadrao:22, cavidadepadrao:16, ativo:true, createdAt:''} },
  { id:'7',  data:'', turno:'SEGUNDO', maquina:'MÁQ 07', produtoNome:'Frasco reto 8',   cicloAtual:42, cavidadeReal:24, velocidade:115, status:'EM_PRODUCAO',  op:null, qtdOP:null, qtdAtual:null, observacao:null, divergente:false, manualOverride:false, produto:{id:'',codigo:'',descricao:'Frasco reto 8',   ciclopadrao:42, cavidadepadrao:24, ativo:true, createdAt:''} },
  { id:'8',  data:'', turno:'SEGUNDO', maquina:'MÁQ 08', produtoNome:'—',               cicloAtual:0,  cavidadeReal:0,  velocidade:0,   status:'INATIVA',      op:null, qtdOP:null, qtdAtual:null, observacao:null, divergente:false, manualOverride:false, produto:null },
  { id:'9',  data:'', turno:'SEGUNDO', maquina:'MÁQ 09', produtoNome:'Caixinha 200ml',  cicloAtual:60, cavidadeReal:12, velocidade:90,  status:'AGUARDANDO_MP',op:null, qtdOP:null, qtdAtual:null, observacao:null, divergente:true,  manualOverride:false, produto:{id:'',codigo:'',descricao:'Caixinha 200ml',  ciclopadrao:55, cavidadepadrao:16, ativo:true, createdAt:''} },
  { id:'10', data:'', turno:'SEGUNDO', maquina:'MÁQ 10', produtoNome:'Tampa Flip Top',  cicloAtual:18, cavidadeReal:48, velocidade:140, status:'EM_PRODUCAO',  op:null, qtdOP:null, qtdAtual:null, observacao:null, divergente:false, manualOverride:false, produto:{id:'',codigo:'',descricao:'Tampa Flip Top',  ciclopadrao:18, cavidadepadrao:48, ativo:true, createdAt:''} },
];
